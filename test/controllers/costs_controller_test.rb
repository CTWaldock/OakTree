...
class CostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post costs_url, params: { cost: { connection: @cost.connection, food: @cost.food, living: @cost.living, other: @cost.other, rent: @cost.rent, travel: @cost.travel, user_id: @cost.user_id } }
    end
  ...
  test "should update cost" do
    patch cost_url(@cost), params: { cost: { connection: @cost.connection, food: @cost.food, living: @cost.living, other: @cost.other, rent: @cost.rent, travel: @cost.travel, user_id: @cost.user_id } }
